...
;EQUB 23, 0, 2, 3      ; Set 6845 register R2 = 45
;EQUB 0, 0, 0
...
ALIGN &100
.SCR_HI_MSB
    EQUB >(SCR+(32*000)+0)+1,>(SCR+(32*000)+1)+1,>(SCR+(32*000)+2)+1,>(SCR+(32*000)+3)+1,>(SCR+(32*000)+4)+1,>(SCR+(32*000)+5)+1,>(SCR+(32*000)+6)+1,>(SCR+(32*000)+7)+1
    EQUB >(SCR+(32*008)+0)+1,>(SCR+(32*008)+1)+1,>(SCR+(32*008)+2)+1,>(SCR+(32*008)+3)+1,>(SCR+(32*008)+4)+1,>(SCR+(32*008)+5)+1,>(SCR+(32*008)+6)+1,>(SCR+(32*008)+7)+1
    EQUB >(SCR+(32*016)+0)+1,>(SCR+(32*016)+1)+1,>(SCR+(32*016)+2)+1,>(SCR+(32*016)+3)+1,>(SCR+(32*016)+4)+1,>(SCR+(32*016)+5)+1,>(SCR+(32*016)+6)+1,>(SCR+(32*016)+7)+1
    EQUB >(SCR+(32*024)+0)+1,>(SCR+(32*024)+1)+1,>(SCR+(32*024)+2)+1,>(SCR+(32*024)+3)+1,>(SCR+(32*024)+4)+1,>(SCR+(32*024)+5)+1,>(SCR+(32*024)+6)+1,>(SCR+(32*024)+7)+1
    EQUB >(SCR+(32*032)+0)+1,>(SCR+(32*032)+1)+1,>(SCR+(32*032)+2)+1,>(SCR+(32*032)+3)+1,>(SCR+(32*032)+4)+1,>(SCR+(32*032)+5)+1,>(SCR+(32*032)+6)+1,>(SCR+(32*032)+7)+1
    EQUB >(SCR+(32*040)+0)+1,>(SCR+(32*040)+1)+1,>(SCR+(32*040)+2)+1,>(SCR+(32*040)+3)+1,>(SCR+(32*040)+4)+1,>(SCR+(32*040)+5)+1,>(SCR+(32*040)+6)+1,>(SCR+(32*040)+7)+1
    EQUB >(SCR+(32*048)+0)+1,>(SCR+(32*048)+1)+1,>(SCR+(32*048)+2)+1,>(SCR+(32*048)+3)+1,>(SCR+(32*048)+4)+1,>(SCR+(32*048)+5)+1,>(SCR+(32*048)+6)+1,>(SCR+(32*048)+7)+1
    EQUB >(SCR+(32*056)+0)+1,>(SCR+(32*056)+1)+1,>(SCR+(32*056)+2)+1,>(SCR+(32*056)+3)+1,>(SCR+(32*056)+4)+1,>(SCR+(32*056)+5)+1,>(SCR+(32*056)+6)+1,>(SCR+(32*056)+7)+1
    EQUB >(SCR+(32*064)+0)+1,>(SCR+(32*064)+1)+1,>(SCR+(32*064)+2)+1,>(SCR+(32*064)+3)+1,>(SCR+(32*064)+4)+1,>(SCR+(32*064)+5)+1,>(SCR+(32*064)+6)+1,>(SCR+(32*064)+7)+1
    EQUB >(SCR+(32*072)+0)+1,>(SCR+(32*072)+1)+1,>(SCR+(32*072)+2)+1,>(SCR+(32*072)+3)+1,>(SCR+(32*072)+4)+1,>(SCR+(32*072)+5)+1,>(SCR+(32*072)+6)+1,>(SCR+(32*072)+7)+1
    EQUB >(SCR+(32*080)+0)+1,>(SCR+(32*080)+1)+1,>(SCR+(32*080)+2)+1,>(SCR+(32*080)+3)+1,>(SCR+(32*080)+4)+1,>(SCR+(32*080)+5)+1,>(SCR+(32*080)+6)+1,>(SCR+(32*080)+7)+1
    EQUB >(SCR+(32*088)+0)+1,>(SCR+(32*088)+1)+1,>(SCR+(32*088)+2)+1,>(SCR+(32*088)+3)+1,>(SCR+(32*088)+4)+1,>(SCR+(32*088)+5)+1,>(SCR+(32*088)+6)+1,>(SCR+(32*088)+7)+1
    EQUB >(SCR+(32*096)+0)+1,>(SCR+(32*096)+1)+1,>(SCR+(32*096)+2)+1,>(SCR+(32*096)+3)+1,>(SCR+(32*096)+4)+1,>(SCR+(32*096)+5)+1,>(SCR+(32*096)+6)+1,>(SCR+(32*096)+7)+1
    EQUB >(SCR+(32*104)+0)+1,>(SCR+(32*104)+1)+1,>(SCR+(32*104)+2)+1,>(SCR+(32*104)+3)+1,>(SCR+(32*104)+4)+1,>(SCR+(32*104)+5)+1,>(SCR+(32*104)+6)+1,>(SCR+(32*104)+7)+1
    EQUB >(SCR+(32*112)+0)+1,>(SCR+(32*112)+1)+1,>(SCR+(32*112)+2)+1,>(SCR+(32*112)+3)+1,>(SCR+(32*112)+4)+1,>(SCR+(32*112)+5)+1,>(SCR+(32*112)+6)+1,>(SCR+(32*112)+7)+1
    EQUB >(SCR+(32*120)+0)+1,>(SCR+(32*120)+1)+1,>(SCR+(32*120)+2)+1,>(SCR+(32*120)+3)+1,>(SCR+(32*120)+4)+1,>(SCR+(32*120)+5)+1,>(SCR+(32*120)+6)+1,>(SCR+(32*120)+7)+1
    EQUB >(SCR+(32*128)+0)+1,>(SCR+(32*128)+1)+1,>(SCR+(32*128)+2)+1,>(SCR+(32*128)+3)+1,>(SCR+(32*128)+4)+1,>(SCR+(32*128)+5)+1,>(SCR+(32*128)+6)+1,>(SCR+(32*128)+7)+1
    EQUB >(SCR+(32*136)+0)+1,>(SCR+(32*136)+1)+1,>(SCR+(32*136)+2)+1,>(SCR+(32*136)+3)+1,>(SCR+(32*136)+4)+1,>(SCR+(32*136)+5)+1,>(SCR+(32*136)+6)+1,>(SCR+(32*136)+7)+1
    EQUB >(SCR+(32*144)+0)+1,>(SCR+(32*144)+1)+1,>(SCR+(32*144)+2)+1,>(SCR+(32*144)+3)+1,>(SCR+(32*144)+4)+1,>(SCR+(32*144)+5)+1,>(SCR+(32*144)+6)+1,>(SCR+(32*144)+7)+1
    EQUB >(SCR+(32*152)+0)+1,>(SCR+(32*152)+1)+1,>(SCR+(32*152)+2)+1,>(SCR+(32*152)+3)+1,>(SCR+(32*152)+4)+1,>(SCR+(32*152)+5)+1,>(SCR+(32*152)+6)+1,>(SCR+(32*152)+7)+1
    EQUB >(SCR+(32*160)+0)+1,>(SCR+(32*160)+1)+1,>(SCR+(32*160)+2)+1,>(SCR+(32*160)+3)+1,>(SCR+(32*160)+4)+1,>(SCR+(32*160)+5)+1,>(SCR+(32*160)+6)+1,>(SCR+(32*160)+7)+1
    EQUB >(SCR+(32*168)+0)+1,>(SCR+(32*168)+1)+1,>(SCR+(32*168)+2)+1,>(SCR+(32*168)+3)+1,>(SCR+(32*168)+4)+1,>(SCR+(32*168)+5)+1,>(SCR+(32*168)+6)+1,>(SCR+(32*168)+7)+1
    EQUB >(SCR+(32*176)+0)+1,>(SCR+(32*176)+1)+1,>(SCR+(32*176)+2)+1,>(SCR+(32*176)+3)+1,>(SCR+(32*176)+4)+1,>(SCR+(32*176)+5)+1,>(SCR+(32*176)+6)+1,>(SCR+(32*176)+7)+1
    EQUB >(SCR+(32*184)+0)+1,>(SCR+(32*184)+1)+1,>(SCR+(32*184)+2)+1,>(SCR+(32*184)+3)+1,>(SCR+(32*184)+4)+1,>(SCR+(32*184)+5)+1,>(SCR+(32*184)+6)+1,>(SCR+(32*184)+7)+1
...
.SCR_HOR
	EQUB 00,00,08,08,16,16,24,24,32,32,40,40,48,48,56,56,64,64,72,72,80,80,88,88,96,96,104,104,112,112,120,120
	EQUB 128,128,136,136,144,144,152,152,160,160,168,168,176,176,184,184,192,192,200,200,208,208,216,216,224,224,232,232,240,240,248,248
	EQUB 00,00,08,08,16,16,24,24,32,32,40,40,48,48,56,56,64,64,72,72,80,80,88,88,96,96,104,104,112,112,120,120
	EQUB 128,128,136,136,144,144,152,152,160,160,168,168,176,176,184,184,192,192,200,200,208,208,216,216,224,224,232,232,240,240,248,248
