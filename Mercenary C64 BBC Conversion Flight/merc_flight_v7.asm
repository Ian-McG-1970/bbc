...
HOR_SCREEN_EDGE_FP = $140c ;; $1900 ; $1800 ; $1c00 ; $1904 ; $140c
VER_SCREEN_EDGE_FP = $1900 ; $193c

SCREEN_VER_BOTTOM = 128 ; $80 ; 8
SCREEN_VER_HALF = 64 ; $40 ; 4
...
;			JSR SWAP_SCREEN_OBJECT
;			JSR	SIN_COS_OBJECT
;			JSR COLOUR_SETUP_BLACK ; COLOUR_SETUP_WHITE ; BLACK
;			JSR DRAW_OBJECTS
;			JSR READ_KEYS_OBJECT

			JSR GET_ROT_FLIGHT
			JSR SWAP_SCREEN_FLIGHT
        JSR DRAW_SCREEN_FLIGHT
        JSR READ_JOYSTICK_KEYBOARD_FLIGHT
        JSR MOVMENT_FLIGHT
...
.DEBUG_WRITE
 ...
 LDA TEMP_0 ; #$EF ; keyShift
 LDX #0
 LDY #0
 JSR HEX8

 LDA TEMP_1 ; #$EF ; keyShift
 LDX #0
 LDY #6
 JSR HEX8

 LDA TEMP_2 ; #$EF ; keyShift
 LDX #0
 LDY #12
 JSR HEX8

 LDA SCREEN_BANK ; #$EF ; keyShift
 LDX #0
 LDY #18
 JSR HEX8
...
.DRAW_SCREEN_FLIGHT
 ...
 sta TEMP_0
			...
			LSR 	A			; shift to remove sign?

			LDX #$F0 ; #$55			; ground colour
			LDY #$0F ; #$AA			; sky colour
...
; rts
 ...
 ldx #$33
 stx TEMP_1
				ADC 	#SCREEN_HOR_HALF ; -1	; change 100825
				CMP 	#SCREEN_HOR_RIGHT ; -1 ; change 100825
...
; stx TEMP_1
 ...
 sta TEMP_0
				CMP 	#SCREEN_VER_BOTTOM ; -1  ; change 100825	; ver clip test
...
; rts
						...
						SEC
						SBC 	#$04
						ASL		A								; set carry if over 256 byte boundary
...
.zp
 EQUB $2f, $35, $81, $51, $7b, $ad, $01, $00
 EQUB $00, $81, $37, $40, $ea, $55, $a0, $40
 EQUB $a7, $54, $00, $00, $00, $00, $5d, $10
 EQUB $00, $00, $00, $34, $30, $88, $28, $81
 EQUB $0a, $18, $4d, $f9, $7e, $40, $76, $84
 EQUB $fe, $ff, $35, $02, $3c, $df, $2e, $e5
 EQUB $00, $00, $2e, $e5, $b2, $19, $4a, $f9
 EQUB $e5, $fd, $5d, $f8, $dd, $fd, $73, $f8
 EQUB $71, $f8, $1e, $e5, $dd, $fc, $37, $f9
 EQUB $e5, $fd, $bb, $f0, $c4, $fc, $4a, $f9
 EQUB $5f, $f9, $00, $49, $03, $58, $47, $49
 EQUB $b0, $49, $e5, $59, $6a, $51, $5f, $49
 EQUB $84, $fc, $51, $f9, $76, $fc, $80, $06
 EQUB $00, $05, $3a, $73, $3b, $71, $80, $00
 EQUB $1b, $20, $7d, $71, $0c, $2c, $0e, $00
 EQUB $49, $8c, $0d, $40, $36, $00, $00, $00
 EQUB $0f, $01, $55, $aa, $00, $0c, $00, $0d
 EQUB $1b, $1b, $20, $20, $38, $04, $50, $42
 EQUB $40, $19, $3c, $18, $07, $19, $16, $18
 EQUB $0b, $a8, $de, $8d, $fd, $44, $fd, $00
 EQUB $74, $8f, $18, $01, $06, $05, $0b, $a9
 EQUB $00, $01, $40, $18, $10, $49, $00, $3f
 EQUB $0f, $00, $08, $00, $3f, $35, $06, $dc
 EQUB $04, $02, $03, $f6, $03, $00, $87, $df
 EQUB $af, $80, $01, $06, $05, $0b, $00, $78
 EQUB $00, $00, $00, $00, $0e, $00, $06, $70
 EQUB $08, $00, $08, $40, $07, $83, $fe, $fb
 EQUB $93, $ee, $40, $b6, $e3, $fa, $02, $00
 EQUB $00, $7d, $14, $59, $2a, $02, $00, $03
 EQUB $70, $04, $ff, $00, $00, $84, $ff, $00
 EQUB $00, $00, $0c, $f9, $00, $00, $7e, $09
 EQUB $00, $00, $00, $00, $a0, $60, $21, $7d
...
.HORIZON_COLUMNS_HI ; LO?
  ...
  EQUB $AA,$AA,$AA,$AA,$AA,$AA,$AA,$AA
  EQUB $AA,$AA,$AA,$AA,$AA,$AA,$AA,$AA
  EQUB $AA,$AA,$AA,$AA,$AA,$AA,$AA,$AA ;; added extra 8 lines to offset for 128 ver

.VER_POS_HI
    EQUB >SC_LN000, >SC_LN001, >SC_LN002, >SC_LN003, >SC_LN004, >SC_LN005, >SC_LN006, >SC_LN007
	EQUB >SC_LN008, >SC_LN009, >SC_LN010, >SC_LN011, >SC_LN012, >SC_LN013, >SC_LN014, >SC_LN015
	EQUB >SC_LN016, >SC_LN017, >SC_LN018, >SC_LN019, >SC_LN020, >SC_LN021, >SC_LN022, >SC_LN023
.HORIZON_COLUMNS_LO ; HI?
	EQUB >SC_LN024, >SC_LN025, >SC_LN026, >SC_LN027, >SC_LN028, >SC_LN029, >SC_LN030, >SC_LN031
    EQUB >SC_LN032, >SC_LN033, >SC_LN034, >SC_LN035, >SC_LN036, >SC_LN037, >SC_LN038, >SC_LN039
    EQUB >SC_LN040, >SC_LN041, >SC_LN042, >SC_LN043, >SC_LN044, >SC_LN045, >SC_LN046, >SC_LN047
	EQUB >SC_LN048, >SC_LN049, >SC_LN050, >SC_LN051, >SC_LN052, >SC_LN053, >SC_LN054, >SC_LN055
	EQUB >SC_LN056, >SC_LN057, >SC_LN058, >SC_LN059, >SC_LN060, >SC_LN061, >SC_LN062, >SC_LN063
	EQUB >SC_LN064, >SC_LN065, >SC_LN066, >SC_LN067, >SC_LN068, >SC_LN069, >SC_LN070, >SC_LN071
	EQUB >SC_LN072, >SC_LN073, >SC_LN074, >SC_LN075, >SC_LN076, >SC_LN077, >SC_LN078, >SC_LN079
    EQUB >SC_LN080, >SC_LN081, >SC_LN082, >SC_LN083, >SC_LN084, >SC_LN085, >SC_LN086, >SC_LN087
	EQUB >SC_LN088, >SC_LN089, >SC_LN090, >SC_LN091, >SC_LN092, >SC_LN093, >SC_LN094, >SC_LN095
	EQUB >SC_LN096, >SC_LN097, >SC_LN098, >SC_LN099, >SC_LN100, >SC_LN101, >SC_LN102, >SC_LN103
	EQUB >SC_LN104, >SC_LN105, >SC_LN106, >SC_LN107, >SC_LN108, >SC_LN109, >SC_LN110, >SC_LN111
	EQUB >SC_LN112, >SC_LN113, >SC_LN114, >SC_LN115, >SC_LN116, >SC_LN117, >SC_LN118, >SC_LN119
    EQUB >SC_LN120, >SC_LN121, >SC_LN122, >SC_LN123, >SC_LN124, >SC_LN125, >SC_LN126, >SC_LN127
...
;  EQUB $12,$12,$12,$12,$12,$12,$12,$12
;  EQUB $14,$14,$14,$14,$14,$14,$14,$14
  EQUB $AA,$AA,$AA,$AA,$AA,$AA,$AA,$AA
...
.HORIZON_DETAIL_RIGHT_WAY_UP	
	EQUB %11100001,%11000011,%10000111,%00001111,%11100001,%11000011,%10000111,%00001111,%11100001,%11000011,%10000111,%00001111,%11100001,%11000011,%10000111,%00001111
	EQUB %11100001,%11000011,%10000111,%00001111,%11100001,%11000011,%10000111,%00001111,%11100001,%11000011,%10000111,%00001111,%11100001,%11000011,%10000111,%00001111
	EQUB %11100001,%11000011,%10000111,%00001111,%11100001,%11000011,%10000111,%00001111,%11100001,%11000011,%10000111,%00001111,%11100001,%11000011,%10000111,%00001111
	EQUB %11100001,%11000011,%10000111,%00001111,%11100001,%11000011,%10000111,%00001111,%11100001,%11000011,%10000111,%00001111,%11100001,%11000011,%10000111,%00001111
	EQUB %11100001,%11000011,%10000111,%00001111,%11100001,%11000011,%10000111,%00001111,%11100001,%11000011,%10000111,%00001111,%11100001,%11000011,%10000111,%00001111
...
.HORIZON_DETAIL_UPSIDE_DOWN	
	EQUB %00011110,%00111100,%01111000,%11110000,%00011110,%00111100,%01111000,%11110000,%00011110,%00111100,%01111000,%11110000,%00011110,%00111100,%01111000,%11110000
	EQUB %00011110,%00111100,%01111000,%11110000,%00011110,%00111100,%01111000,%11110000,%00011110,%00111100,%01111000,%11110000,%00011110,%00111100,%01111000,%11110000
	EQUB %00011110,%00111100,%01111000,%11110000,%00011110,%00111100,%01111000,%11110000,%00011110,%00111100,%01111000,%11110000,%00011110,%00111100,%01111000,%11110000
	EQUB %00011110,%00111100,%01111000,%11110000,%00011110,%00111100,%01111000,%11110000,%00011110,%00111100,%01111000,%11110000,%00011110,%00111100,%01111000,%11110000
	EQUB %00011110,%00111100,%01111000,%11110000,%00011110,%00111100,%01111000,%11110000,%00011110,%00111100,%01111000,%11110000,%00011110,%00111100,%01111000,%11110000
