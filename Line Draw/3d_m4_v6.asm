...
MACRO CLEARLINE address
	...
	STA address+(100*32),X
	STA address+(101*32),X
	STA address+(102*32),X
	STA address+(103*32),X
	STA address+(104*32),X
	STA address+(105*32),X
	STA address+(106*32),X
	STA address+(107*32),X
	STA address+(108*32),X
	STA address+(109*32),X

	STA address+(110*32),X
	STA address+(111*32),X
	STA address+(112*32),X
	STA address+(113*32),X
	STA address+(114*32),X
	STA address+(115*32),X
	STA address+(116*32),X
	STA address+(117*32),X
	STA address+(118*32),X
	STA address+(119*32),X

	STA address+(120*32),X
	STA address+(121*32),X
	STA address+(122*32),X
	STA address+(123*32),X
	STA address+(124*32),X
	STA address+(125*32),X
	STA address+(126*32),X
	STA address+(127*32),X
ENDMACRO
