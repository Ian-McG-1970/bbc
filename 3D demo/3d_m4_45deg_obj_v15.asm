...
X_CLASSIFY_PNT_LO = X_CLIP_S_PNT_LO
X_CLASSIFY_PNT_HI = X_CLIP_S_PNT_HI
Y_CLASSIFY_PNT_LO = Y_CLIP_S_PNT_LO
Y_CLASSIFY_PNT_HI = Y_CLIP_S_PNT_HI
...
.INFRONT:
      STA   Z_PNT_HI
			...
			MVA16	X_PNT_LO, X_CLASSIFY_PNT_LO
			MVA16	Y_PNT_LO, Y_CLASSIFY_PNT_LO
...
.X_CHECK	LDA		X_CLASSIFY_PNT_HI
			BPL		X_POS
				NGT_16	X_CLASSIFY_PNT_LO	; negate x
.X_NEG			CP_16 	X_CLASSIFY_PNT_LO, Z_PNT_LO
				BCC 	Y_CHECK 	; if NUM1L < NUM2L then NUM1 < NUM2
.X_NEG_OFF			LDX		#2
					BNE		Y_CHECK	; jmp - use bne
	
.X_POS		CP_16 	X_CLASSIFY_PNT_LO, Z_PNT_LO
			BCC 	Y_CHECK
.X_POS_OFF		LDX		#1			;				BNE		Y_CHECK		; jmp - use beq

.Y_CHECK	LDA		Y_CLASSIFY_PNT_HI
			BPL		Y_POS
				NGT_16	Y_CLASSIFY_PNT_LO	; negate y
.Y_NEG			CP_16 	Y_CLASSIFY_PNT_LO, Z_PNT_LO
				BCC 	QUIT
.Y_NEG_OFF			TXA
					ORA		#8
					RTS
	
.Y_POS		CP_16	Y_CLASSIFY_PNT_LO, Z_PNT_LO
			BCC 	QUIT
.Y_POS_OFF		TXA
				ORA		#4
				RTS
...
.PROJECT_XY	; in = Y=Z_PNT_LO - X=Z_PNT_HI / X_PNT_HI-X_PNT_LO / Y_PNT_HI-Y_PNT_LO
{
;			INY
;			BNE	.CONT_Z_INC
;				INX
